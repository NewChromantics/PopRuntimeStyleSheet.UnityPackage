...
// Type: RuntimeStyleSheet.UIElements.StyleSheets.StylePropertyCache
...
namespace RuntimeStyleSheet.UIElements.StyleSheets
{
  internal static class StylePropertyCache
  {
    ...
    public static bool TryGetSyntax(string name, out string syntax) => StylePropertyCache.s_PropertySyntaxCache.TryGetValue(name, out syntax);

    public static bool TryGetNonTerminalValue(string name, out string syntax) => StylePropertyCache.s_NonTerminalValues.TryGetValue(name, out syntax);

    public static string FindClosestPropertyName(string name)
    {
      float num1 = float.MaxValue;
      string closestPropertyName = (string) null;
      foreach (string key in StylePropertyCache.s_PropertySyntaxCache.Keys)
      {
        float num2 = 1f;
