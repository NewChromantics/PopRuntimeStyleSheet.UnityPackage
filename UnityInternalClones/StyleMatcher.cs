...
// Type: RuntimeStyleSheet.UIElements.StyleSheets.StyleMatcher
...
namespace RuntimeStyleSheet.UIElements.StyleSheets
{
  internal class StyleMatcher : BaseStyleMatcher
  {
    ...
    public MatchResult Match(RuntimeStyleSheet.UIElements.StyleSheets.Syntax.Expression exp, string propertyValue)
    {
